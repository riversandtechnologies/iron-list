...
`,
  ...
  _deletePool: function () {
    ...
    if (children) {
      ...
      while (this.firstChild) {
        if (this.firstChild.tagName && this.firstChild.tagName.toLowerCase() == "template") {
          template =  this.firstChild;
        }
  ...
  _positionItems: function() {
    ...
    if (this.grid) {
      ...
      this._iterateItems(function(pidx, vidx) {
        ...
        this._physicalItems[pidx].style.left = x+'px';
        this._physicalItems[pidx].style.top = y+'px';
  ...
  _resizeHandler: function() {
    this._debounce('_render', function() {
      ...
      //commented as part of edge performance
  ...
  _createFocusBackfillItem: function() {
    ...
    // Hide the focused physical.
     ...
     this._offscreenFocusedItem.style.top = HIDDEN_Y;
    },
  ...
  _restoreFocusedItem: function() {
    ...
    if (onScreenInstance[this.as] === offScreenInstance[this.as]) {
      ...
      this._focusBackfillItem.style.top = HIDDEN_Y;
    } else {
      this._removeFocusedItem();
      this._focusBackfillItem = null;
    }
